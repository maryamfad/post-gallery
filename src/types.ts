...
export type PostReactionState = Record<string, boolean>;
export type PostGalleryProps = {
	postsInitialData: GetPostsResponse;
	postLikes: PostReactionState;
	postUpvotes: PostReactionState;
	setPostLikes: React.Dispatch<React.SetStateAction<Record<string, boolean>>>;
	setPostUpvotes: React.Dispatch<
